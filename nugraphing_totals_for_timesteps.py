#graphing the totals versus time
total_sums_list = []
times = []
...
for i in np.arange(1, 10694): 
    ...
    total_sum = nc_nue_ar40_sum + nc_nuebar_ar40_sum + nc_numu_ar40_sum + nc_numubar_ar40_sum + nc_nutau_ar40_sum + nc_nutaubar_ar40_sum + nue_ar40_sum + nuebar_ar40_sum + nue_ar40_electron_sum + nuebar_ar40_electron_sum  + numu_ar40_electron_sum + numubar_ar40_electron_sum + nutau_ar40_electron_sum + nutaubar_ar40_electron_sum
...
plt.grid(True)
plt.savefig("/lustre/orion/ast137/proj-shared/colterrichardson/Neutrinos_Summer_2026/2D/sam_summer2026/snowglobessumsplot.png")
plt.show()
